...
public:
  ...
  {
    // Chuyển đổi từ sensor_msgs::PointCloud2 sang pcl::PointCloud<pcl::PointXYZRGB>
    ...
    pcl::PointCloud<pcl::PointXYZRGB>::Ptr floor_removed_cloud(new pcl::PointCloud<pcl::PointXYZRGB>);
...
void removeFloor(const pcl::PointCloud<pcl::PointXYZRGB>::Ptr& input_cloud,
                 pcl::PointCloud<pcl::PointXYZRGB>::Ptr& floor_removed_cloud)
{
